...
Route::get('products/review', [
    'as' => 'admin.products.getReviewdProducts',
    'uses' => 'ProductController@getReviewdProducts',
    'middleware' => 'can:admin.products.index',
]);
Route::post('products/email', [
    'as' => 'admin.products.email',
    'uses' => 'ProductController@email',
    'middleware' => 'can:admin.products.index',
]);
